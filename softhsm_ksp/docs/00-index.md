...
| [09 — Test suite](./09-tests.md) | Four-layer test pyramid: unit tests (1053 assertions, 89.7 % coverage), integration tests (40 tests), PowerShell HLK suite (~150 tests) |
...
Windows Application
  ...
  ncrypt.dll ──── registry: HKLM\...\SoftHSM KSP\Image
       ...
       ▼
softhsm_ksp.dll
  ├── ksp_*()          Implements the 26 slots of the CNG table
