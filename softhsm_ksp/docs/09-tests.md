...
```
   ...
   │         16 test suites · 1095 assertions · gcov coverage         │
   │         Lines: 89.0 %    Functions: 100 %                       │
   └────────────────────────────────────────────────────────────────┘
```
...
| ECDH agreement | `test_ecdh.c` | 115 | `KSP_SecretAgreement`, `KSP_DeriveKey`, `KSP_FreeSecret`, `KSP_IsValidSecret`; DER unwrapping of the peer point on all three curves |
...
|--------|------:|----:|:------:|----------:|----:|:------:|
| **Total** | **2282** | **2032** | **89.0 %** | **90** | **90** | **100 %** |
