...
This README is the overview. Five generated documents go deeper, each
...
```bash
# Regenerate all five:
for g in generate_feature_spec generate_install_guide generate_kmip_design_doc          generate_docs generate_phase_report; do python "$g.py"; done
```
