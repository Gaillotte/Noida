...
│   ├── tests/
│   │   ├── unit/                   Layer 1 — 21 test suites, 1434 assertions, Linux/GCC, no SoftHSM2
│   │   │   ├── Makefile
...
make run           # 21 suites, 1434 assertions
make coverage      # → coverage_html/index.html (88.5 % lines, 100 % functions)
